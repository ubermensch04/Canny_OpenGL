 ...
 *
 *  @snippet samples/jni/tutorial_code/gapi/doc_snippets/api_ref_snippets.jni Untyped_Example
 *
 *  Here:
 *
 ...
 *
 *  @snippet samples/jni/tutorial_code/gapi/doc_snippets/api_ref_snippets.jni Typed_Example
 *
