 ...
 *
 * @snippet samples/jni/tutorial_code/gapi/doc_snippets/api_ref_snippets.jni graph_def
 *
 * Full pipeline can be now captured with this object declaration:
 *
 * @snippet samples/jni/tutorial_code/gapi/doc_snippets/api_ref_snippets.jni graph_cap_full
 *
 ...
 * defined like this:
 *
 * @snippet samples/jni/tutorial_code/gapi/doc_snippets/api_ref_snippets.jni graph_cap_sub
 *
...
public:
     ...
     *
     * @snippet samples/jni/tutorial_code/gapi/doc_snippets/api_ref_snippets.jni graph_gen
     *
