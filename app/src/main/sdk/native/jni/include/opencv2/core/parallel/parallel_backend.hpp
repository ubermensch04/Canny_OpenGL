 ...
 *   @snippet parallel_backend/example-tbb.jni tbb_include
 * - execute backend replacement code:
 *   @snippet parallel_backend/example-tbb.jni tbb_backend
 ...
 *   @snippet parallel_backend/example-openmp.jni openmp_include
 * - execute backend replacement code:
 *   @snippet parallel_backend/example-openmp.jni openmp_backend
 * - Configuration of compiler/linker options is responsibility of Application's scripts
 *
 *
 * ### Plugins support
