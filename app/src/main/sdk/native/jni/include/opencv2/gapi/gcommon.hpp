 ...
 *
 * @snippet samples/jni/tutorial_code/gapi/doc_snippets/api_ref_snippets.jni graph_decl_apply
 *
 * Extra parameter specifying which kernels to compile with can be
 * passed like this:
 *
 * @snippet samples/jni/tutorial_code/gapi/doc_snippets/api_ref_snippets.jni apply_with_param
 */
